...
import 'package:ootms/presentation/screens/role/driver/home/driver_map.dart';

class DriverSetLocationPage extends StatelessWidget {
  const DriverSetLocationPage({super.key});
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      animetedNavigationPush(const DriverMapPage(), context);
                    },
                  ),
                ),
                const SizedBox(
