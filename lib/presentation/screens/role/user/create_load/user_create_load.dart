          ...
          return Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                commonTextfieldWithTitle(
                    "Shipper Phone", value.shipperPhoneController,
                    hintText: "Enter phone number",
                    keyboardType: TextInputType.number),
                const SizedBox(height: 16),
                commonTextfieldWithTitle(
                    "Shipper Email", value.shipperEmailController,
                    hintText: "Enter email address",
                    onValidate: OtherHelper.emailValidator,
                    keyboardType: TextInputType.emailAddress),
                const SizedBox(height: 16),
                ...
                Row(
                  children: [
                    Expanded(
                      child: commonTextfieldWithTitle(
                          "City", value.shipperCityController,
                          hintText: "Enter city",
                          onValidate: OtherHelper.validator),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: commonTextfieldWithTitle(
                          "State", value.shipperStateController,
                          hintText: "Enter state",
                          onValidate: OtherHelper.validator),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: commonTextfieldWithTitle(
                          "Zip", value.shipperZipController,
                          hintText: "Enter zip",
                          onValidate: OtherHelper.validator),
                    ),
                  ],
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: commonTextfieldWithTitle(
                        "Pickup Time",
                        value.pickupTimeController,
                        readOnly: true,
                        hintText: "hh:mm",
                        suffinxIcon: InkWell(
                            onTap: () {
                              value.pickPickupTime();
                            },
                ...
                Card(
                  ...
                  child: AnimatedContainer(
                    ...
                    height: value.isHazMat == true ? 600 : 100,
                ...
                Consumer<LoadController>(
                  builder: (context, value, child) {
                    return commonIconButton(
                      ...
                      onTap: () {
                        if (shipperFormKey.currentState!.validate()) {
                          setState(() {
                            _tabController!.index = 1;
                            // value.createLoad();
                            print("===================================${shipperFormKey.currentState!.validate()}");
                          });
                        }
                      },
                    );
